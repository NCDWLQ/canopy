...
- **Stale binding baseline** `conversation-stale-binding`: root `node-stale-root`; binding `(NULL, stale-orphan-model, low)` — retained for a future `0007` cleanup regression; this fixture does not repair it.
